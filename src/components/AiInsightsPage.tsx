...
import { School, Student, RiskLevel, PricingPlan } from '../types';
import { getAiDebtAnalysis } from '../services/geminiService';
...
const AiInsightsPage: React.FC<AiInsightsPageProps> = ({ school, plan }) => {
    ...
    if (!hasAccess) {
        return (
            <>
                <UpgradePrompt currentPlanName={plan?.name || 'Basic'} onUpgrade={() => setShowUpgradeModal(true)} />
